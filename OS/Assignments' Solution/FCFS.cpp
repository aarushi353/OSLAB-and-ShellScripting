...
int main(){
    ...
    // service similar to head, we are updating it accordingly
    ...
    float avg_turn_around_time = (float)total_turnaround/(float)process;

    cout << "Total wait time is " << total_wait << endl;
    cout << "Average wait time is " << avg_wait_time << endl; 
    cout << "Total turn around time is " << total_turnaround << endl;
